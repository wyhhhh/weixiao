...
class LoginController extends AppKeeperController {
    ...
    public function login(){
       //验证 登录
        ...
        if ($result) {
            ...
            $res_data['status'] = 1;
            $res_data['data']['manageid'] = $keeperid;
            ...
            $map_save['loginuser'] = $keeperid;
            $map_save['object'] = 4;//记录对象: 1_业主, 2_DD维修, 3_社区维修, 4_APP管理员, 5_物业管理员, 6_平台管理员
