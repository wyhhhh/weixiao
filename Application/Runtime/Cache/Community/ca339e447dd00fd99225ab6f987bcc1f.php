...
<html>
	...
	<head>
		...
		<title>物业banner管理</title>
		<meta name="keywords" content="物业banner管理">
		<meta name="物业banner管理">
					...
					<div class="ibox-content">
						<div class="row row-lg">
							<div class="col-sm-12 me-search" >
	                                <input id="search_name" style="width: 200px;" placeholder="请输入广告标题" type="text"  class="form-control" >
