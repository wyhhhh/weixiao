                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal m-t" id="mainForm" data-NoClientValidate="1">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">维修人员选择</label>
                                <div class="col-sm-8">
                            <select  style="width: 150px;" class="form-control" name="people" id="people" required="true" >
                                        <option selected="" value="">维修人员</option>
                                        <?php if(is_array($rolelists)): $i = 0; $__LIST__ = $rolelists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vols): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vols["id"]); ?>" <?php if(($vols["id"]) == $info["people"]): ?>selected='selected'<?php endif; ?> ><?php echo ($vols["phone"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input placeholder="请输入标题" name="fname" class="form-control" type="text" required="true"value="<?php echo ($info["fname"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">内容</label>
                                <div class="col-sm-8">
                                    <input placeholder="请输入内容" name="fname" class="form-control" type="text" required="true"value="<?php echo ($info["fname"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
