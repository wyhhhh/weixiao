            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                            <!-- 批量添加 -->
                        <form action="<?php echo U('Payfees/uploads');?>" method="POST" id="mainForm"enctype="multipart/form-data">
                            <center>     <label  class="divcss5">Excel录入 </label>                            
                           ...
                           <center>
                           <a href="<?php echo U('Payfees/Excel_xiazai');?>"> <button type="button" class="btn btn-outline btn-default"  data-uri="<?php echo U('Payfees/Excel_xiazai');?>"><a href="<?php echo U('Payfees/Excel_xiazai');?>">下载格式Excel
