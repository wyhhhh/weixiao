                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal m-t" id="mainForm" data-NoClientValidate="1">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">所属小区名称：</label>
                                <div class="col-sm-8">
                                	<input placeholder="请输入所属小区名称" name="communityid" class="form-control" type="text"  value="<?php echo ($info['communityid']); ?>" required="true" > 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">名称（栋/幢）</label>
                                <div class="col-sm-8">
                                    <input placeholder="请输入名称（栋/幢）" name="name" class="form-control" type="text"  value="<?php echo ($info['name']); ?>" required="true" > 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">房屋代码</label>
                                <div class="col-sm-8">
                                    <input placeholder="请输入房屋代码" name="alias_name" class="form-control" type="text" required="true" value="<?php echo ($info["alias_name"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">物管费单价</label>
                                <div class="col-sm-8">
                                    <input placeholder="请输入物管费单价" name="unit_price" class="form-control" type="text" required="true" number='true' value="<?php echo ($info["unit_price"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
