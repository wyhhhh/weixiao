            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                            <!-- 批量添加 -->
                        <form action="<?php echo U('Users/uploads');?>" method="POST" id="mainForm" enctype="multipart/form-data">
                            <center>     <label  class="divcss5">用户添加</label>                            
                           ...
                           <center>
                           <a href="<?php echo U('Users/download');?>"> <button type="button" class="btn btn-outline btn-default"  data-uri="<?php echo U('Users/download');?>"><a href="<?php echo U('Users/download');?>">下载格式Excel
