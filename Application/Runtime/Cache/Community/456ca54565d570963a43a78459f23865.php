                    ...
                    <div class="ibox-content">
                        <form method="post" class="form-horizontal m-t" id="mainForm" data-NoClientValidate="1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select style="width: 150px;" class="form-control" name="range" id="range" required="true">
                                        <option selected="" value="">请选择发布范围</option>
                                        <?php if(is_array($rolelists)): $i = 0; $__LIST__ = $rolelists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vols): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vols["id"]); ?>" <?php if(($vols["id"]) == $info["range"]): ?>selected='selected'<?php endif; ?> ><?php echo ($vols["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input placeholder="标题" name="title" class="form-control" type="text" required="true" number='true' value="<?php echo ($info["title"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">内容</label>
                                <div class="col-sm-8">
                                    <input placeholder="内容" name="content" class="form-control" type="text" required="true" number='true' value="<?php echo ($info["content"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
