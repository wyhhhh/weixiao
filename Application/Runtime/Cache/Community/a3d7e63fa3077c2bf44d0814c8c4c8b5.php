...
<html>
	...
	<head>
		...
		<title>公共维修人员管理</title>
		<meta name="keywords" content="公共维修人员管理">
		<meta name="公共维修人员管理">
						...
						<div class="row row-lg">
							<div class="col-sm-12 me-search" >
									...
									<select style="width: 150px;" class="form-control" id = "status">
                                        ...
                                        <option value="1">物业管理公共维修人员DD维修</option>
                                        <option value="2">物业公共维修人员社区服务人员</option>
                                        <option value="3">系统推送消息到用户</option>
                                        <option value="4">网站反馈结果公共维修人员消息</option>
                                    </select>
								...
								<div class="example-wrap">
									<div class="example">
										<div class="btn-group hidden-xs" id="table-toolbar" role="group">
											<button type="button" class="btn btn-outline btn-default J_showdialog" data-uri='<?php echo U("add2");?>' data-title="发送" data-width="1000" data-height="800">选择发送
		                                    </button>
										</div>
				...
				$('#tablelist').bootstrapTable($.extend(true, bootstrap_table.datagridDefaultConfig, {
					...
					},
					{
						...
						formatter: function(value, row, index) { 
							...
							var background = '<a href="javascript:void(0);" onclick="showDialog(this)" data-full="1" data-uri="' + backgroundUrl + '" data-title="公共维修人员" data-width="1000" data-height="800" >公共维修人员</a>&nbsp;';
							strs += " " + background;
							return strs;
						}
					}]
