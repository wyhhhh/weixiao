					...
					<div class="ibox-content">
						<div class="row row-lg">
							<div class="col-sm-12 me-search" >
	                                <input id="search_username" style="width: 200px;" placeholder="请输入管理员名称" type="text"  class="form-control" >
				...
				$('#tablelist').bootstrapTable($.extend(true, bootstrap_table.datagridDefaultConfig, {
					...
					},
					{
						...
						formatter: function(value, row, index) { 
							...
							var edit_filed = "<a data-val='" + newstatus + "' data-id='" + id + "' href='javascript:void(0)' data-uri='" + edit_filed_url + "'   onclick='updateField(this)' data-msg='你确认要修改" + name + "的启用状态吗？' >" + status_text + "</a>";
							strs += " " + edit_filed;
							//编辑
