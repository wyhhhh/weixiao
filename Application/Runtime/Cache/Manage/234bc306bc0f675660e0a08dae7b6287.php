...
<html>
	...
	<head>
		...
		<title>业主封号/解封记录</title>
		<meta name="keywords" content="业主封号/解封记录">
		<meta name="业主封号/解封记录">
					...
					<div class="ibox-content">
						<div class="row row-lg">
							<div class="col-sm-12 me-search" >
	                                <input id="search_name" style="width: 200px;" placeholder="请输入业主姓名" type="text"  class="form-control" >
...
<script src="/wuyeguanli/Public/hplus/js/content.js" charset="UTF-8"></script>
		...
		<script type="text/javascript">
			var url = "<?php echo U('ajax_getList');?>?key=<?php echo ($_GET['key']); ?>&sid=<?php echo ($_GET['sid']); ?>";
			// 搜索 （根据条件重新加载数据）
