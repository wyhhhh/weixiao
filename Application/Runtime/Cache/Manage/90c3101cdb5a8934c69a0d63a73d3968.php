...
<html>
	...
	<head>
		...
		<title>服务人员封号/解封记录</title>
		<meta name="keywords" content="服务人员封号/解封记录">
		<meta name="服务人员封号/解封记录">
					...
					<div class="ibox-content">
						<div class="row row-lg">
							<div class="col-sm-12 me-search" >
	                                <input id="search_name" style="width: 200px;" placeholder="请输入服务人员姓名" type="text"  class="form-control" >
									<select style="width: 150px;" class="form-control" name = "manageid"
                                    id= "manageid" required="true">
                                        <option selected="" value = "">请选择操作人</option>
                                        <?php if(is_array($mname)): $i = 0; $__LIST__ = $mname;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$volist): $mod = ($i % 2 );++$i;?><option value="<?php echo ($volist["id"]); ?>"><?php echo ($volist["username"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
...
<script src="/wuyeguanli/Public/hplus/js/content.js" charset="UTF-8"></script>
		...
		<script type="text/javascript">
			var url = "<?php echo U('ajax_getList');?>?key=<?php echo ($_GET['key']); ?>&rid=<?php echo ($_GET['rid']); ?>";
			// 搜索 （根据条件重新加载数据）
