...
<head>
    ...
    <title>千万家  - 登录</title>
    <meta name="keywords" content="千万家">
    <meta name="description" content="千万家">
...
<body class="signin">
    <div class="signinpanel">
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <div class="m-b"></div>
                    <h4>欢迎进入 <strong>千万家后台管理系统</strong></h4>
                    <ul class="m-b">
        ...
        <div class="signup-footer">
            <div class="pull-left">
                &copy; 2016 All Rights Reserved. 西罗亚
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function Submit() {
            ...
            if (username == "") {
                ...
                $.post("<?php echo U('Manage/Index/index');?>", {
                    username: username,
                    password: password,
                    code: code
                },
                function (res) {
                    if (res.status == 1) {
                        ...
                        window.location.href = "<?php echo U('Manage/Index/main');?>";
                    }
                    else {
                        updateCode();
                        layer.alert(res.msg, {
