				...
				$('#tablelist').bootstrapTable($.extend(true, bootstrap_table.datagridDefaultConfig, {
					...
					},
					{
						...
						formatter: function(value, row, index) {
							...
							//查看封号记录
							var detUrl = "<?php echo U('Sequestration/indextwo');?>?rid=" + id + "&key=2"; 
							...
							strs += " " + detail;
							var withholdUrl = "<?php echo U('withhold');?>?id=" + id;
							...
							strs += " " + withhold;
							var repairUrl = "<?php echo U('Repair/index');?>?id=" + id; 
							...
							strs += " " + repair;
							var fundUrl = "<?php echo U('FundRecord/index');?>?uid=" + id; 
