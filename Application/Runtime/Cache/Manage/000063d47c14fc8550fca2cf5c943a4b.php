...
<html>
	...
	<head>
		...
		<title>社区管理</title>
		<meta name="keywords" content="社区管理">
		<meta name="社区管理">
				...
				$('#tablelist').bootstrapTable($.extend(true, bootstrap_table.datagridDefaultConfig, {
					...
					},
					{
						...
						formatter: function(value, row, index) { 
							...
							strs += " " + del;
							//进入社区后台
							var background = '<a href = "">进入社区后台</a>&nbsp;';
							strs += " " + background;

							//编辑
							var testUrl = "<?php echo U('test');?>?id=" + id;
							var test = '<a href="javascript:void(0);" onclick="showDialog(this)"  data-uri="' + testUrl + '" data-title="test" data-width="800" data-height="600" >test</a>&nbsp;';
							strs += " " + test;
							//test2
							var test2Url = "<?php echo U('test2');?>?id=" + id;
							var test2 = '<a href="javascript:void(0);" onclick="showDialog(this)"  data-uri="' + test2Url + '" data-title="test2" data-width="500" data-height="200" >test2</a>&nbsp;';
							strs += " " + test2;
