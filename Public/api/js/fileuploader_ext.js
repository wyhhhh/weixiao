...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        onComplete: function(id, fileName, responseJSON, obj){},
    ...
    if (this._options.button){
        btn = this._options.button;
        //jquery object
        if(btn.context!=undefined){
            btn.each(function(){
                that._createUploadButton($(this).get(0));
            })
        }else{
...
qq.FileUploaderBasic.prototype = {
    ...
    _createUploadHandler: function(){
        ...
        var handler = new qq[handlerClass]({
            ...
            onComplete: function(id, fileName, result){
                obj = self._button;
                self._onComplete(id, fileName, result ,obj);
                self._options.onComplete(id, fileName, result, obj);
            },
            onCancel: function(id, fileName){
    ...
    _onComplete: function(id, fileName, result, obj){
...
qq.UploadHandlerAbstract = function(o){
    ...
    this._options = {
        ...
        maxConnections: 999,
        onProgress: function(id, fileName, loaded, total){},
        onComplete: function(id, fileName, response ,obj){},
        onCancel: function(id, fileName){},
        onUpload: function(id, fileName, xhr){}
    };
    qq.extend(this._options, o);
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _upload: function(id, params){
        ...
        this._attachLoadEvent(iframe, function(){
            ...
            var obj = self._button;

            self._options.onComplete(id, fileName, response, obj);
            self._dequeue(id);
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _onComplete: function(id, xhr, obj){
        ...
        this._options.onComplete(id, name, response , obj);
